...
## 팀원 및 담당 주제
* **2025193150 CUI ZIXUN**: LU Decomposition with Partial Pivoting (완료/2026.06.02 확인)
* **2026193010 LI HUIBIN**: Conjugate Gradient Method
* **2026193019 LI HANGXI**: Multiderivative(Multivariate) Newton-Raphson (완료/2026.06.02 확인)
* **2026193228 김민교**: Broyden's Method
* **2024199084 안의빈**: Power Iteration, Inverse Power Iteration 
* **2024199021 박세영 (조장)**: QR Algorithm with Shifts (완료/ 2026.06.02 확인)
